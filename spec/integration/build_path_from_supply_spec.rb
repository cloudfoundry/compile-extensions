  ...
  context 'deps dir exists' do
    ...
    context 'pkgconfig paths are provided' do
      ...
      it 'PKG_CONFIG_PATH is written to stdout' do
        ...
        if ENV.has_value?('PKG_CONFIG_PATH')
